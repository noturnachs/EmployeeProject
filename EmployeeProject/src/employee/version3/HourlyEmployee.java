...
public class HourlyEmployee extends Employee{
    ...
    public HourlyEmployee(int empID, Name empName, String empDateHired, String empBirthDate) {
        super(empID, empName, empDateHired, empBirthDate);
    }

    public HourlyEmployee(int empID, Name empName, String empDateHired, String empBirthDate, int totalHoursWorked, float ratePerHour) {
        super(empID, empName, empDateHired, empBirthDate);
